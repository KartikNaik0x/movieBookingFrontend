...
export class MovieapiService {
 ...
 // movieServiceUrl = 'http://18.236.37.36:8083/api/v1.0/moviebooking';
  ...
  updateTicketCount(movieName:string,sumTickets:number,token:string){
    ...
    return this.http.put<any>(this.movieServiceUrl+`/update/${movieName}/${sumTickets}`,movieName,options);
  }
